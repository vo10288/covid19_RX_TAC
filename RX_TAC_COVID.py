...
#			return detect_faces_in_image2(file)
	...
	<tr><td>
	<h2>Research the COVID-19 with RX or TAC IMAGE -- ATTENTION THIS METOD IS EXPERIMENTAL !! diagnoses can only be made by specialist doctors</h2>
...
def detect_faces_in_image(file_stream):
	...
	command = ('python3 classifyCovid_RX_TAC.py -i '+'uploadRx/'+filenames+'/image.jpg')
